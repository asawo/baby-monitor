...
// Set baby name from config.js (generated by `just setup`)
const babyName: string = (window as unknown as Record<string, string>).BABY_NAME ?? 'Baby';
const title = `${babyName} Monitor`;
document.title = title;
(el('page-heading') as HTMLElement).textContent = title;
